...
## Instructions to set up the Bert Chatbot Chinese Demo on Local system

1. Clone the repository in your system.
2. Download the model file from https://drive.google.com/file/d/1-PCQPkbFzHtR21rT1GfaxSGWR7VgJD-p/view?usp=sharing and unzip it in root directory.
